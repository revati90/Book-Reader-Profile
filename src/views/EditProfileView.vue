    ...
    <div class="edit-profile-section">
      ...
      <div class="p-3 py-2">
        <form @submit.prevent="updateProfile">
          <div class="row mt-2">
            ...
            <div class="mb-3">
              <input
                ...
                v-model="getUserProfile.firstName"
              />
            </div>
            <div class="mb-3">
              <input
                ...
                v-model="getUserProfile.lastName"
              />
            </div>
            <div class="mb-3">
              <input
          ...
          <div class="text-center py-2">
            <button
              class="form-control btn btn-default btn-outline-warning"
              @click="cancelProfieForm"
            >
              Cancel
            </button>
          </div>
